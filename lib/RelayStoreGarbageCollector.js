...
RelayStoreGarbageCollector=(function(){
...
function RelayStoreGarbageCollector(
relayStoreData)
...
this._cycles = 0;}RelayStoreGarbageCollector.prototype.
...
scheduleCollection = function scheduleCollection(stepLength){var _this=this;
...
function(){return _this._collectGarbageStep(
currentCycle,
iterator,
iterator.next(),
stepLength);});};RelayStoreGarbageCollector.prototype.
...
_collectGarbageStep = function _collectGarbageStep(
currentCycle,
remainingDataIDs,
offset,
stepLength)
...
{var _iterator=
iterator;neglectionState = _iterator.value;
if(neglectionState){
...
if(!iterator.done){
resolveImmediate(function(){return RelayTaskScheduler.await(
function(){return _this2._collectGarbageStep(
currentCycle,
remainingDataIDs,
iterator,
stepLength);});});}else 
...
{
this._neglectionStates = this._bufferedNeglectionStates;}};RelayStoreGarbageCollector.prototype.
...
decreaseSubscriptionsFor = function decreaseSubscriptionsFor(dataID){
this._neglectionStates.decreaseSubscriptionsFor(dataID);};RelayStoreGarbageCollector.prototype.
...
increaseSubscriptionsFor = function increaseSubscriptionsFor(dataID){
this._neglectionStates.increaseSubscriptionsFor(dataID);};RelayStoreGarbageCollector.prototype.
...
register = function register(dataID){
this._neglectionStates.register(dataID);};RelayStoreGarbageCollector.prototype.
...
_isCollectible = function _isCollectible(neglectionState){
...
queuedStore.hasRange(neglectionState.dataID)));};RelayStoreGarbageCollector.prototype.
...
_removeRecordAndDescendentClientRecords = function _removeRecordAndDescendentClientRecords(dataID){
...
range.getEdgeIDs().forEach(function(id){return enqueueField({__dataID__:id});});}else 
{
...
field.forEach(enqueueField);}else 
{
enqueueField(field);}});}
...
return removedRecords;};RelayStoreGarbageCollector.prototype.
...
_removeRecord = function _removeRecord(record){
...
this._neglectionStates.remove(dataID);};return RelayStoreGarbageCollector;})();
