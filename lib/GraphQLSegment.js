...
var GraphQLStoreDataHandler=require('./GraphQLStoreDataHandler');var 
...
function GraphQLSegment(){_classCallCheck(this,GraphQLSegment);
...
this._count = 0;
this._minIndex = null;
this._maxIndex = null;}GraphQLSegment.prototype.
...
_getIndexForCursor = function _getIndexForCursor(cursor){
return this._cursorToIndexMap[cursor];};GraphQLSegment.prototype.
...
_getIndexForID = function _getIndexForID(id){
var indices=this._idToIndicesMap[id];
return indices && indices[0];};GraphQLSegment.prototype.





getFirstCursor = function getFirstCursor(){
if(this.getLength()){
for(var ii=this._minIndex;ii <= this._maxIndex;ii++) {
var metadata=this._indexToMetadataMap[ii];
if(!metadata.deleted){
return metadata.cursor;}}}};GraphQLSegment.prototype.
...
var metadata=this._indexToMetadataMap[ii];
if(!metadata.deleted){
return metadata.edgeID;}}}};GraphQLSegment.prototype.
...
_getEdgeAtIndex = function _getEdgeAtIndex(index){
var edge=this._indexToMetadataMap[index];
return edge && !edge.deleted?edge:null;};GraphQLSegment.prototype.
...
containsEdgeWithID = function containsEdgeWithID(id){
var index=this._getIndexForID(id);
if(index === undefined){
return false;}

return !!this._getEdgeAtIndex(index);};GraphQLSegment.prototype.
...
containsEdgeWithCursor = function containsEdgeWithCursor(cursor){
...
getMetadataAfterCursor = function getMetadataAfterCursor(count,cursor){
if(!this.getLength()){
return {
edgeIDs:[],
cursors:[]};}
...
return {
edgeIDs:edgeIDs,
cursors:cursors};};GraphQLSegment.prototype.
...
getMetadataBeforeCursor = function getMetadataBeforeCursor(count,cursor){
if(!this.getLength()){
return {
edgeIDs:[],
cursors:[]};}
...
cursors:cursors.reverse()};};GraphQLSegment.prototype.
...
_addEdgeAtIndex = function _addEdgeAtIndex(edge,index){
if(this.getLength() === 0){
this._minIndex = index;
this._maxIndex = index;}else 
if(this._minIndex == index + 1){
this._minIndex = index;}else 
...
if(cursor){
this._cursorToIndexMap[cursor] = index;}};GraphQLSegment.prototype.
...
edge,
this._minIndex !== null?this._minIndex - 1:0);};GraphQLSegment.prototype.
...
this._addEdgeAtIndex(
edge,
this._maxIndex !== null?this._maxIndex + 1:0);};GraphQLSegment.prototype.
...
removeEdge = function removeEdge(id){
var index=this._getIndexForID(id);
if(index === undefined){
console.warn(
...
data.deleted = true;
this._count--;};GraphQLSegment.prototype.
...
removeAllEdges = function removeAllEdges(id){
var indices=this._idToIndicesMap[id];
if(!indices){
return;}
...
addEdgesAfterCursor = function addEdgesAfterCursor(edges,cursor){
...
this._addEdgeAtIndex(
edge,
startIndex + ii);}};GraphQLSegment.prototype.
...
addEdgesBeforeCursor = function addEdgesBeforeCursor(edges,cursor){
...
return this._maxIndex - this._minIndex + 1;};GraphQLSegment.prototype.
...
return this._count;};GraphQLSegment.prototype.
...
_rollback = function _rollback(cursorRollbackMap,idRollbackMap,counters){
...
this._minIndex = counters.minIndex;};GraphQLSegment.prototype.





_getCounterState = function _getCounterState(){
return {
count:this._count,
maxIndex:this._maxIndex,
minIndex:this._minIndex};};GraphQLSegment.prototype.
...
concatSegment = function concatSegment(segment){
...
this._idToIndicesMap[newEdge.edgeID].slice();}else 
{
...
this._idToIndicesMap[newEdge.edgeID].unshift(index);}else 
if(!newEdge.deleted){
console.warn(
...
this._idToIndicesMap[newEdge.edgeID] || [];
this._idToIndicesMap[newEdge.edgeID].push(index);}}else 
...
this._cursorToIndexMap[newEdge.cursor] = index;}else 
if(!newEdge.deleted){
console.warn(
...
return true;};GraphQLSegment.prototype.
...
descriptor,6);var indexToMetadataMap=_descriptor[0];var idToIndicesMap=_descriptor[1];var cursorToIndexMap=_descriptor[2];var minIndex=_descriptor[3];var maxIndex=_descriptor[4];var count=_descriptor[5];
...
return segment;};GraphQLSegment.prototype.
...
cursorToIndex:this._cursorToIndexMap};};GraphQLSegment.prototype.
...
return Object.keys(this._idToIndicesMap);};return GraphQLSegment;})();
