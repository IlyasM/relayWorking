...
var FIELD_ARGUMENT_ENCODING=/^(\w+)\((.*?)\)$/;var 
NODE=RelayConnectionInterface.NODE;var EDGES=RelayConnectionInterface.EDGES;var 
ID=RelayNodeInterface.ID;var NODE_TYPE=RelayNodeInterface.NODE_TYPE;
...
parentType:NODE_TYPE}));}else 

if(key === EDGES){
children.push(RelayQuery.Field.build('cursor'));}else 
if(key === ID){
metadata = {
...
!
captures?process.env.NODE_ENV !== 'production'?invariant(false,
